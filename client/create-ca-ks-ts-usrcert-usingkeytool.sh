...
export cltcertdname="CN=client,OU=TestOrg,O=TestCompany,L=Denver,ST=Colorado,C=US"
export cltksname="client.jks"
export cltkeyalias="client"
export cltkeypass="password"
export cltkspass="password"
export cltkscsr="client.csr"
export cltkscert="client.crt"
export cltkspubcert="client.crt"
export cltp12ks="client.p12"
export cltkskey="client.key"
...
sign_cert $caksname $caalias $capwd $cltkscsr $cltkscert $cltkeyalias
...
export_pub_cert $cltksname $cltkeyalias $cltkeypass $cltkspass $cltkspubcert
